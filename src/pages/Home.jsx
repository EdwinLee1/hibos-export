  ...
  return (
    <div className="space-y-8">
              ...
              <table className="w-full text-sm">
                <thead className="bg-surface-dark">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 font-medium text-gray-400">{t('home.thName')}</th>
                    <th className="text-left px-4 py-3 font-medium text-gray-400">{t('home.thCategory')}</th>
                    <th className="text-left px-4 py-3 font-medium text-gray-400">{t('home.thIngredients')}</th>
      ...
      <footer className="mt-12 pt-6 border-t border-border text-center text-xs text-gray-500 space-y-1 pb-4">
        <p>{t('home.footer.companyName')}</p>
        <p>{t('home.footer.bizNumber')}</p>
